...
Hintsilent "Shoot a white flare grenade toward your recon area";
...
if (isNull _granat) exitWith {Hintsilent "Not a correct ammo for HuntIR.";myhuntiraction = player addAction ["use HuntIR", "scripts\myhuntir.sqf", [], 1, false, true, "", "true"];};
